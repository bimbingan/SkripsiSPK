<?php /* Smarty version Smarty-3.0.7, created on 2015-08-09 09:54:20
         compiled from "application/views\pengaturan/operator/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:117355c7072cc0c825-22970856%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '117355c7072cc0c825-22970856',
  'function' => 
  array (
  ),
...
<?php $_tmp2=ob_get_clean();?><?php if ($_tmp2=='P'){?>checked="checked"<?php }?> />PEREMPUAN</label>
                    ...
                    <td>Jabatan</td>
                    <td>
                        <input name="operator_jabatan" type="text" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('result')->value['operator_jabatan'])===null||$tmp==='' ? '' : $tmp);?>
