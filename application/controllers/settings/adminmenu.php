...
class adminmenu extends ApplicationBase {
    ...
    public function navigation($portal_id) {
        ...
        // load css
        $this->smarty->load_style("operator/font/font-awesome/css/font-awesome.css");
        // get data portal
    ...
    public function add($portal_id) {
        ...
        // load css
        $this->smarty->load_style("operator/css/bootstrap.css");
        $this->smarty->load_style("operator/font/font-awesome/css/font-awesome.css");
        $this->smarty->load_style("admin/css/fontawesome-iconpicker.css");
        // get last parent id
